...
public class GuiMagicTrinkets extends GuiContainer
{
	...
	public GuiMagicTrinkets(Container c,EntityPlayer player,InventoryPlayer ip, InventoryMagicTrinkets imt)
	{
	...
	*/
	...
	this.fontRendererObj.drawString(this.inventory.getInventoryName(), 80, this.ySize - 96, 4210752);
	}
