...
public class WeaponFighterPierce extends ItemSword
{

	IIcon[] textures = new IIcon[2];
	public WeaponFighterPierce(ToolMaterial mat) 
	{
		super(mat);
	}
	...
	{
		UtilityNBTHelper.setString(par1ItemStack, Rot.MODID+"weaponType", "pierce");
	...
	public void registerIcons(IIconRegister ir)
	{
		...
		{
			textures[i] = ir.registerIcon(Rot.MODID+":"+"weapons/fighter_pierce_"+(i+1));
		}
	}
