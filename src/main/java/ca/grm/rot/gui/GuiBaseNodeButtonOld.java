 ...
 * button
 **/
public class GuiBaseNodeButtonOld extends GuiButton {
	public int		x, y, z;
	public float	brightness	= 1.0f;
	public Block block;
	
	public GuiBaseNodeButtonOld(int par1, int par2, int par3, int par4, int par5,
			String par6Str) {
	...
	public void drawButton(Minecraft p_146112_1_, int p_146112_2_, int p_146112_3_) {
		if (this.visible) {
			...
			//if (this.tex != null) {
				drawRect(this.xPosition, this.yPosition, this.xPosition + 16, this.yPosition + 16, this.packedFGColour);
			...
			if(this.hovered)this.drawCenteredString(fontrenderer, this.displayString, this.xPosition
