...
public class CommonProxy {
	...
	// * @param compound An NBT Tag Compound that stores the
	// IExtendedEntityProperties data only
	// */
	...
	//
	// /**
	// * Removes the compound from the map and returns the NBT tag stored for
	...
	//
	// /**
	// * This cleans up the onEntityJoinWorld event by replacing most of the
	// code
