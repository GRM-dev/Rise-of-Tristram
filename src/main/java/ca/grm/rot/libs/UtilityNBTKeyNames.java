...
public class UtilityNBTKeyNames {
	...
	public static String	bladeHeadEffect	= Rot.MODID + "bladeHeadEffectIndex";
	public static String	guardEffect		= Rot.MODID + "guardEffectIndex";
	public static String	handleEffect		= Rot.MODID + "handleEffectIndex";
